...
1. **Clone o repositório** ```bash
   git clone [https://github.com/Lucas-Siqueira1/health-guardian-ai.git](https://github.com/Lucas-Siqueira1/health-guardian-ai.git) 
...
6. **Gere os relatos a partir do dataset**
   Baixe o dataset no link abaixo e salve como `data/dataset.csv`: 
...
8. **Execute as interfaces** **Interface do profissional**
   ```bash
